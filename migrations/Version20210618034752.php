 ...
 */
final class Version20210618034752 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE acceptees CHANGE date_rendez_vous date_rendez_vous DATE NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE acceptees CHANGE date_rendez_vous date_rendez_vous DATE DEFAULT NULL');
